...
<main id="primary" class="main-content">
    <div class="speaker-spotlight speaker-spotlight--secondary">
        <div class="speaker-spotlight__container">
            <div class="speaker-spotlight__content">
                <div class="speaker-spotlight__heading">
                    <h3 class="header">Speaker Spotlight</h3>
                </div>
                <div class="speaker-spotlight__details">
                    <div class="speaker-spotlight__text">
                        <p class="speaker-spotlight__summary">Lorem ipsum dolor sit amet, consectetur adipiscing elit,
                            sed
                            do
                        ...
                        <em class="speaker-spotlight__panel">Data and Government Panelist 2020</em>
                    </div>
                    <hr class="line" />
