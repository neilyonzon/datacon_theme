/******/ (function(modules) {
        ...
        if (document.querySelector(".timer__number--days")) {
          var start = setInterval(function() {
            ...
            document.querySelector(
              ".timer__number--minutes"
            ).innerText = minutes;
            document.querySelector(
              ".timer__number--seconds"
            ).innerText = seconds;
  ...
  \*********************/
      ...
      /***/ function(module, exports, __webpack_require__) {
        var getNavigation = __webpack_require__(
          /*! ./navigation.js */ "./js/navigation.js"
        );

        var getMediaplayer = __webpack_require__(
          /*! ./media-player.js */ "./js/media-player.js"
        );

        var countdown = __webpack_require__(
          /*! ./countdown.js */ "./js/countdown.js"
        );

        var getKeyNoteModal = __webpack_require__(
          /*! ./keynotes-speakers-modal */ "./js/keynotes-speakers-modal.js"
        );
      ...
      /***/ function(module, exports) {
        ...
        (function() {
          ...
          var profileLinks = document.querySelectorAll(
            ".keynote-speakers__link"
          );
          var modalBackground = document.querySelector(
            ".keynote-speakers-modal__overlay"
          );
          var closeIcon = document.querySelector(
            ".keynote-speakers-modal__close"
          ); //Functions
          ...
          var fillModalDetails = function fillModalDetails(e) {
            ...
            var profileName = parentNode.querySelector(".profile-item__name")
              .innerText;
            var profileTitle = parentNode.querySelector(".profile-item__title")
              .innerText;
            var profileImage = parentNode
              .querySelector(".profile-item__img")
              .getAttribute("src");
            var profileAlt = parentNode
              .querySelector(".profile-item__img")
              .getAttribute("alt");
            var profileDescription = parentNode.querySelector(
              ".profile-item__description"
            ).innerText;
            var profileSocial = parentNode
            ...
            if (
              modalSocial.querySelector(".profile-item__social-icons-container")
            ) {
              var child = modalSocial.querySelector(
  ...
  \*********************************************/
      ...
      /***/ function(module, exports, __webpack_require__) {
        __webpack_require__(
          /*! /Users/neilyonzon/Local Sites/data-con-la/app/public/wp-content/themes/datacon_theme/js/index.js */ "./js/index.js"
        );
        module.exports = __webpack_require__(
          /*! /Users/neilyonzon/Local Sites/data-con-la/app/public/wp-content/themes/datacon_theme/sass/style.scss */ "./sass/style.scss"
        );
